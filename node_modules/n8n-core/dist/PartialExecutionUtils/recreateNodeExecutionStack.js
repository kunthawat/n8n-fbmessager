                ...
                if (sourceData.complete) {
                    ...
                    for (const incomingConnection of sourceData.connections) {
                        ...
                        if (pinData[sourceNode.name]) {
                            ...
                            const nodeIncomingData = (0, getIncomingData_1.getIncomingDataFromAnyRun)(runData, sourceNode.name, incomingConnection.type, incomingConnection.outputIndex);
                            if (nodeIncomingData) {
                    ...
                    for (const incomingConnection of sourceData.connections) {
                        const sourceNode = incomingConnection.from;
                        const maybeNodeIncomingData = (0, getIncomingData_1.getIncomingDataFromAnyRun)(runData, sourceNode.name, incomingConnection.type, incomingConnection.outputIndex);
