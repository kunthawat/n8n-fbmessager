...
export interface IGetExecuteWebhookFunctions {
    (workflow: Workflow, node: INode, additionalData: IWorkflowExecuteAdditionalData, mode: WorkflowExecuteMode, webhookData: IWebhookData, closeFunctions: CloseFunction[], runExecutionData: IRunExecutionData | null): IWebhookFunctions;
}
...
export declare class NodeExecutionOutput extends Array<INodeExecutionData[]> {
    constructor(data: INodeExecutionData[][], hints?: NodeExecutionHint[]);
    static [Symbol.hasInstance](instance: unknown): instance is any[] & Record<"getHints", unknown>;
