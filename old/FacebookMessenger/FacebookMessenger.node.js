...
var FacebookMessenger = /** @class */ (function () {
    ...
    FacebookMessenger.prototype.execute = function () {
        return __awaiter(this, void 0, void 0, function () {
            var items, returnData, length, i, credentials, operation, recipientId, messageType, messageData, messageText, mediaType, mediaUrl, body, requestOptions, response, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        requestOptions = {
                            method: 'POST',
                            url: "https://graph.facebook.com/v21.0/".concat(credentials.pageId, "/messages"),
                            headers: {
